...
# Extract data
eeg_data = mat_data['LCN']['trials'][0][0][797:1012,:,:]  # Adjust the indices based on your file contents
...
for i in range(powered_avg.data.shape[0]):
    ...
    plt.title(f'LCN Power Spectrogram - Rat_id: 6 '+ch_names[i])  # Set the title for the plot
