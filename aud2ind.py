...
# Extract data
eeg_data = mat_data['AUD']['trials'][0][0][185:393,:,:]  # Adjust the indices based on your file contents
...
for i in range(powered_avg.data.shape[0]):
    ...
    plt.title(f'AUD Power Spectrogram Rat_id: 3 '+ch_names[i])  # Set the title for the plot
