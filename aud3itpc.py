...
data = data_dict['AUD']['trials'][0][0][394:589,:,:] # This should be of shape (trials, channels, timepoints)
...
for i in range(3):
    ...
    plt.plot(itpc[i, :])
    plt.title('AUD Intertrial Phase Coherence (ITPC) for Rat_id: 5 '+chnnls[i])
