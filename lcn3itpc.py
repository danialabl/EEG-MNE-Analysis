...
data = data_dict['LCN']['trials'][0][0][398:609,:,:]  # This should be of shape (trials, channels, timepoints)
...
for i in range(3):
    ...
    plt.plot(itpc[i, :])
    plt.title('LCN Intertrial Phase Coherence (ITPC) for Rat_id: 4 '+chnnls[i])
