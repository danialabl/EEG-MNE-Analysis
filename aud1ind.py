...
# Extract data
eeg_data = mat_data['AUD']['trials'][0][0][0:184,:,:]  # Adjust the indices based on your file contents
...
for i in range(powered_avg.data.shape[0]):
    ...
    plt.title(f'AUD Power Spectrogram Rat_id: 2 '+ch_names[i])  # Set the title for the plot
